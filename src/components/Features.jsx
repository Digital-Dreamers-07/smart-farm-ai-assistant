  ...
  return (
    <section className="bg-green-50 py-16">
      <div className="max-w-6xl mx-auto  px-6 text-center">
        <h2 className="text-4xl md:text-4xl font-bold text-green-700 mb-12"style={{color:"#166534",fontSize:"40px"}}>
        ...
        <div className="mt-6  grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-4 flex justify-center" style={{color:"#16a34a"}}>{feature.icon}</div>
              <h3 className="text-lg font-semibold text-green-700 mb-2" style={{color:"#166534",fontSize:"20px"}}>
                {feature.title}
              </h3>
